<?php
    ...
    $page = "Recipe Finder";
    $pageDesc = "Recipe Finder of the Clever Cooks site";
    $toolbarFooter = true;
    $body = "finder-content.php";
    $user = $_SESSION['user'];
    ...
    $stmt = $pdo->prepare('SELECT r.recipe_id, r.name, r.title, r.photo FROM recipes r ORDER BY r.recipe_id DESC LIMIT 12');
    if ($stmt->execute()) {
